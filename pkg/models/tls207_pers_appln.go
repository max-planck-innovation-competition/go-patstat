...
type Tls207PersAppln struct {
	...
	AppltSeqNr int16 `json:"appltSeqNr" gorm:"column:applt_seq_nr;type:smallint;default:0;not null"`
	InvtSeqNr  int16 `json:"invtSeqNr" gorm:"column:invt_seq_nr;type:smallint;default:0;not null"`
}

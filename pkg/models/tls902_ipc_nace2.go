...
type Tls902IpcNace2 struct {
	Ipc           string `json:"ipc" gorm:"column:ipc;type:varchar(8);default:'';not null"`
	NotWithIpc    string `json:"notWithIpc" gorm:"column:not_with_ipc;type:varchar(8);default:'';not null"`
	UnlessWithIpc string `json:"unlessWithIpc" gorm:"column:unless_with_ipc;type:varchar(8);default:'';not null"`
